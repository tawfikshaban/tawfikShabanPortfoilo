...
watch(visibility, (current) => {
  if (current === "hidden") {
    ...
    title.value = "Tawfik CV | Frontend Developer";
  }
});
...
useHead({
  title: "Tawfik CV | Frontend Developer",
});
onMounted(() => {
  ...
  document.querySelector("main > figure img").addEventListener("click", (e) => {
    // document.querySelector("main > figure").classList.toggle("opened");
    /*     position: fixed;
    left: 0;
    top: 0;
    width: 100vw;
  ...
  <div class="cvPage">
    ...
    <main>
      <article>
        ...
        <ul>
          <p>or you can work with me on platforms. like :</p>
          <li>
            <NuxtLink
              to="https://www.upwork.com/freelancers/~01db4fd2b6b9bb8022"
              class="text"
              target="_blank"
              >Upwork</NuxtLink
            >
          ...
          <li>
            <NuxtLink
              to="https://khamsat.com/user/tawfik_shaban"
              class="text"
              target="_blank"
              >Khamsat</NuxtLink
            >
          ...
          <li>
            <NuxtLink
              to="https://mostaql.com/u/Tawfik_shaban1"
              class="text"
              target="_blank"
              >Mostaql</NuxtLink
            >
          ...
          <li>
            <NuxtLink
              to="https://www.awwwards.com/tawfik-shaban/"
              class="text"
              target="_blank"
              >Awwwards</NuxtLink
            >
      ...
      <figure>
        <NuxtImg
          src="/images/tawfik_shaban_cv.jpg"
          alt="tawfik picture"
          width="300"
          height="400"
        />
...
main > figure {
  ...
  align-items: flex-start;
  height: 90%;
  transition: all 0.4s var(--secund-transition);
