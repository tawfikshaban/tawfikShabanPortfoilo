...
watch(visibility, (current) => {
  if (current === "hidden") {
    ...
    title.value = "Tawfik Shaban | Projects";
  }
});
...
const works = ref([
  {
    ...
    title: "Opulent Store",
    date: "2025",
    image: "/images/opulent_MacBook.svg",
    video: "/videos/opulent.webm",
    url: "https://tawfik-store.vercel.app/",
    margin: "0",
  },
  {
    id: 2,
    title: "Magma",
    date: "2025",
    image: "/images/magma_MacBook_Air.svg",
    video: "/videos/magma.webm",
    url: "https://tawfikshaban.github.io/3d-app/",
    margin: "300",
  },
  {
    id: 3,
    title: "Basic Agency",
    date: "2025",
    image: "/images/basic_MacBook.svg",
    video: "/videos/basic.webm",
    url: "https://tawfikshaban.github.io/basicAgancy-clone/",
    margin: "0",
  },
  {
    id: 4,
    ...
    date: "2025",
    image: "/images/dashboard_MacBook.svg",
    video: "/videos/dashboard.webm",
    url: "https://tawfikshaban.github.io/template-four/",
    margin: "300",
  },
  {
    id: 5,
    title: "Simple Carousel Slider",
    date: "2025",
    image: "/images/carousel_slider.png",
    video: "/videos/carousel.webm",
    url: "https://tawfikshaban.github.io/Carousel-Slider/",
    margin: "0",
  },
  {
    id: 6,
    title: "Easy Bank",
    date: "2025",
    image: "/images/easybank_macbook.svg",
    url: "https://tawfikshaban.github.io/easybank-landing-page-master/",
    video: "/videos/easyBank.webm",
    margin: "300",
  },
  {
    id: 7,
    title: "Simple Menu With Cart",
    date: "2025",
    image: "/images/landing_cart_iPhone.svg",
    video: "/videos/cart.webm",
    url: "https://tawfikshaban.github.io/product-list-with-cart-main/",
    margin: "0",
  },
  {
    id: 8,
    ...
    date: "2024",
    image: "/images/simple_company_website.png",
    video: "/videos/company.webm",
    url: "https://tawfikshaban.github.io/Tawfik-Company/",
    margin: "300",
  },
  {
    id: 9,
    title: "Tawfik World",
    date: "2024",
    image: "/images/tawfik_world.png",
    video: "/videos/world.webm",
    url: "https://tawfikshaban.github.io/tawfik-template/",
    margin: "0",
  },
  {
    id: 10,
    ...
    video: "/videos/kasper.webm",

    url: "https://tawfikshaban.github.io/template-two/",
    margin: "300",
  },
  {
    id: 11,
    ...
    video: "/videos/leon.webm",

    url: "https://tawfikshaban.github.io/template_one/",
    margin: "0",
  },
]);
const overViewImgSrc = ref("");
const overViewTitle = ref("");
const overViewDate = ref("");
const overViewLink = ref("");
const overViewVideo = ref("");
useHead({
  title: "Tawfik Shaban | Projects",
});
...
onMounted(() => {
  ...
  //       document.querySelector(".works-container >figure").style.left =
  //         e.clientX + "px";
  //       document.querySelector(".works-container >figure").style.top =
  //         e.clientY + "px";
  //     });
  //   });

  // gsap.to(" header figure svg", {
  //   scrollTrigger: {
  //     trigger: " .hero",
  //     scrub: 0.5,
  ...
  document.fonts.ready.then(() => {
    ...
    // console.log(arrayOfSplitText);

    document.querySelectorAll(".work").forEach((li) => {
      console.log();

      li.classList.add(`workNum${li.id}`);
      if (document.body.clientWidth >= 786) {
        li.addEventListener("mouseenter", async (e) => {
          if (!e.target.classList.contains("active")) {
            let arrayOfSplitText = gsap.utils.toArray(
              `.workNum${e.target.id}` + " .split",
            );
            arrayOfSplitText.forEach((e) => {
              gsap.set(e, {
                opacity: 1,
              });
              SplitText.create(e, {
        ...
        console.log("mouse enter animation is not in range");
      }
    });
    document.querySelectorAll(".work .mask").forEach((mask) => {
      gsap.to(mask, {
        scaleY: 0,
        ease: "var(--main-transition)",
        duration: 2,
...
async function updateSrc(
  ...
  date,
  link,
  video = String || "/video/opulent",
) {
  overViewImgSrc.value = source;
  overViewTitle.value = title;
  overViewDate.value = date;
  overViewLink.value = link;
  overViewVideo.value = video;
  show.value = true;
  document.querySelector(".workPage").style.height = "100dvh";
  ...
  requestAnimationFrame(() => {
    setTimeout(() => {
      ...
      tl.to(
        ".workOverView figure:first-of-type",
        {
          duration: 0.5,
          ease: "var(--main-transition)",
          opacity: 1,
      ...
      let splitTest = SplitText.create(".workOverView h2", {
        type: "word,chars",
        mask: "chars",
        smartWrap: true,
      });
      ...
      tl.from(
...

        {
          ...
          y: 100,
          mask: "chars",
          onComplete: () => splitTest.revert(),
        },
        2,
      );

      tl.to(
        ".workOverView figure:first-of-type svg",
        {
          duration: 0.5,
          ease: "var(--main-transition)",
          opacity: 1,
    ...
    document.querySelector(".workOverView video").play();
  });
}
...
async function closeWindow() {
  requestAnimationFrame(() => {
    ...
    tl.to(".workOverView figure:first-of-type svg", {
      duration: 0.5,
      ease: "var(--main-transition)",
      opacity: 0,
      // y: 100,
    ...
    tl.to(
...

      {
        ...
        y: 100,
        mask: "chars",
        onComplete: () => setTimeout(() => splitTest.revert(), 1000),
      },
      0,
    );
    ...
    document.querySelector(".workOverView video").pause();
  });
}
</script>
<template>
    ...
    <main>
      <section id="container">
        <ul class="works-container">
          <li
            @click="
              updateSrc(work.image, work.title, work.date, work.url, work.video)
            "
            :id="work.id"
            class="work"
            v-for="work in works"
            :key="work.id"
            :data-url="work.url"
            :style="{ 'margin-top': work.margin + 'px' }"
          >
            <figure>
              <NuxtImg
                :data-scroll="!show"
                :data-scroll-speed="{ '0.2': !show }"
                width="300"
                height="300"
                :src="work.image"
                loading="eager"
            ...
            <article :data-scroll="!show" :data-scroll-speed="{ '0.2': !show }">
              <h2 class="split">{{ work.title }}</h2>
              <h2 class="split">{{ work.date }}</h2>
            </article>
          </li>
        </ul>
      </section>
      <div class="workOverView">
        ...
        <figure class="videoContainer">
          <NuxtLink :to="overViewLink" target="_blank">
            <video
              width="300"
              height="300"
              :poster="overViewImgSrc"
              fetchpriority="high"
              playsinline
              autoplay
              muted
        ...
        <div class="linkAndButton">
          <button class="closeImageButton" @click="closeWindow">
            <span></span><span></span>
          </button>
          <NuxtLink class="linkButton" target="_blank" :to="overViewLink">
            <svg
              width="32px"
              height="32px"
              viewBox="0 0 24 24"
...
.cols {
  ...
  width: 20%;
  height: 200%;
  background-color: var(--secundBlue-color);
...
.close {
  ...
  cursor: pointer;
  transition:
    color 0.6s var(--main-transition),
    borderColor 0.6s var(--main-transition);
}
...
.works-container li article {
  width: 100%;
  height: 50%;
  text-align: center;
  font-size: clamp(1.9vw, 23px, 100%);
  text-wrap: balance;
  letter-spacing: 3px;
  line-height: 50px;
  cursor: pointer;
...
.works-container li figure {
  position: relative;
  width: 150%;
  height: 80%;
}

.works-container article h2 {
  opacity: 1;
  height: 100%;
  width: 100%;
}

.works-container article h2:nth-child(2) {
  font-family: "HAL", monospace;
  color: var(--blue-color);
}

.works-container li:hover figure img {
...
.works-container li img {
  ...
  border-radius: 16px;
  /* flex: 1; */
  transition: filter 0.6s var(--main-transition);
  will-change: filter;
...
.workOverView {
  ...
  transition: transform 0.4s var(--secund-transition);
}
...
.linkButton {
  ...
  align-items: center;
  border-radius: 50%;
  transition: all 0.5s var(--main-transition);
  overflow: hidden;
  background-color: var(--black-color);
  cursor: pointer;
}
...
.linkButton:hover svg {
  animation: moveArrow 1s var(--main-transition);
}
...
.closeImageButton span:first-child {
  transform: rotate(45deg);
}

.closeImageButton span:last-child {
  transform: rotate(135deg);
}

.closeImageButton:hover span:first-child {
  animation: xAnimationFirst 1s var(--main-transition);
}
.closeImageButton:hover span:last-child {
  animation: xAnimationLast 1s var(--main-transition);
}
.workOverView figure {
  width: 50%;
  height: 100%;
...
@media screen and (max-width: 767px) {
  ...
  .workOverView figure.videoContainer {
    width: 95vw;
    height: 50vh;
    order: 3;
    display: flex;
...
@media screen and (min-width: 1000px) {
  ...
  .workOverView h2:first-child::after {
    content: "";
    position: absolute;
    bottom: -50px;
    left: 0;
  ...
  .workOverView h2:first-child:hover::after {
    transform: scaleX(1);
    transform-origin: left;
  }
}
