...
watch(visibility, (current) => {
  if (current === "hidden") {
    ...
    title.value = "Tawfik Shaban | Works";
  }
});
...
const works = ref([
  ...
  },
  {
    ...
    date: "2025",
    image: "/images/menu_with_cart.png",
