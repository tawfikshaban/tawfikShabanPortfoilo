...
watch(visibility, (current) => {
  if (current === "hidden") {
    ...
    title.value = "Tawfik Shaban | Portfolio";
  }
});
...
useHead({
  title: "Tawfik Shaban | Portfolio",
});

useSeoMeta({
  title: "Tawfik Shaban | Portfolio",
  ogTitle: "Web Programmer & UI Specialist",
  description:
    "مطور ويب متخصص في بناء تجارب رقمية تفاعلية باستخدام Nuxt 4 و GSAP، مع تركيز عالي على الأداء والأنيميشن.",
  ogDescription:
    "استكشف مشاريعي في تطوير الواجهات المتقدمة والحلول البرمجية المبتكرة.",
  ogImage: "/images/ogImage.png", // هنظبطها لما تبعت الهيرو سيكشن
});
...
onMounted(() => {
  ...
  let contentIsLoaded = ref(false);

  if (contentIsLoaded.value === false) {
    document.body.style.height = "100vh";
    document.body.style.overflow = "hidden";
  }

  pixelEffect("/images/me.jpeg", 0.5);

  document.querySelector("#canvas").addEventListener("click", (e) => {
    pixelEffect("/images/me.jpeg", 0);
  });
  ...
  document.fonts.ready.then(() => {
    mm.add("(prefers-reduced-motion: no-preference)", () => {
      ...
      gsap.to(" .left-side-top .span-reveal", {
        translateX: "120%",
        duration: 1.3,
        delay: 3.7,
      });

      gsap.from(" .hero .hero-bottom-text-container", {
        translateY: "40px",
        duration: 1,
        delay: 2.8,
      });
      ...
      document
        .querySelectorAll(" .hero .right-side .span-reveal")
        .forEach((span) => {
          gsap.to(span, {
            translateX: "120%",
            duration: 1.3,
      ...
      gsap.to(" .hero-bottom-text-container", {
        scrollTrigger: {
          trigger: " .hero",
          scrub: true,
          toggleActions: "play none none reverse",
      ...
      gsap.to(" section.three h3.first-h3 .span-reveal", {
        scrollTrigger: {
          trigger: " section.three ",
          start: "20% center",
          end: "end center",
      ...
      gsap.to(" section.three h3.secund-h3 .span-reveal", {
        scrollTrigger: {
          trigger: " section.three ",
          start: "20% center",
          end: "end center",
      ...
      gsap.to(" section.three h3.third-h3 .span-reveal", {
        scrollTrigger: {
          trigger: " section.three ",
          start: "20% center",
          end: "end center",
      ...
      if (document.body.clientWidth >= 769) {
        let splitTest = SplitText.create(".hero .split", {
          type: "chars, words, lines",
        });

        let elements = document.querySelectorAll(" .text");

        splitTest.chars.forEach((letter) => {
          letter.addEventListener("mouseover", (l) => {
            l.target.style.color = "var(--main-green)";
            gsap.fromTo(
              letter,
              {
                fontWeight: 900,
      ...
      tl.to(" .side-section .inner-horizontal", {
        scrollTrigger: {
          trigger: " section.four",
          start: "center center",
          end: "110% center",
      ...
      gsap.to("  section.five h2 .span-reveal", {
        scrollTrigger: {
  ...
  function pixelEffect(source, times = 1) {
    let scale = { value: 25 };
    ...
    async function update() {
      let sw = (cw / scale.value) >> 0;
      let sh = (ch / scale.value) >> 0;
...
setTimeout(() => {
  ...
  tl.set(" .top", {
    clipPath: "xywh(0px -787px 100% 100% round 0% 0%)",
    duration: 3,
    ease: "power4.inOut",
  });
  ...
  tl.set(
    ".hero",
    {
      clipPath: "xywh(0px 0px 100% 100% round 0% 0%)",
      duration: 3,
      ease: "power4.inOut",
    },
...
<template>
  <div data-scroll class="homePage">
    <div class="scroller"></div>

    <div class="loading-block">
      <div class="top">
        <h4>LOAD TAWFIK <span class="before"></span></h4>
      </div>
      <div class="center">
...
"
    ...
    <main>
      <section class="hero">
        <h4 class="scroll-word">scroll down</h4>
        <h1 class="left-side-top">
          <span class="span-reveal"></span>
          <span class="split" data-scroll
            >Hi,<br />
            I’m Tawfik Shaban</span
          >
        </h1>
        <!-- <img  src="/images/me.jpeg" alt="tawfik shaban"> -->
        <canvas id="canvas" width="900" height="900"></canvas>
        <article class="right-side" data-scroll data-scroll-speed="0.2">
          <h2 class="split">
            Front-End
            <span class="span-reveal"></span>
          </h2>
        ...
        <article class="hero-bottom-text-container">
          <h3 class="left-side-bottom">
            <span class="vue">Vue.js</span>
            <span>*</span>
            <span class="nuxt">Nuxt</span>
            <span>*</span>
            <span class="gsap">Animations</span>
            <span>*</span>
      ...
      <section class="two marquee">
        <article class="marquee-inner">
          <div class="right-direction">
            <h2 class="black move-right">TAWFIK SHABAN DEVELOPER</h2>
            <h2 class="black move-right">TAWFIK SHABAN DEVELOPER</h2>
            <h2 class="black move-right">TAWFIK SHABAN DEVELOPER</h2>
            <h2 class="black move-right">TAWFIK SHABAN DEVELOPER</h2>
          </div>
          <div class="left-direction">
            <h2 class="white move-left">TAWFIK SHABAN DEVELOPER</h2>
            <h2 class="white move-left">TAWFIK SHABAN DEVELOPER</h2>
            <h2 class="white move-left">TAWFIK SHABAN DEVELOPER</h2>
            <h2 class="white move-left">TAWFIK SHABAN DEVELOPER</h2>
          </div>
      ...
      <section class="three">
        ...
        <article>
          <h3 class="first-h3" data-scroll data-scroll-speed="0.2">
            <span class="span-reveal"></span
            ><span style="color: var(--main-green-color)">Performance</span>
            first
          </h3>
          <h3 class="secund-h3" data-scroll data-scroll-speed="0.2">
            <span class="span-reveal"></span
            ><span style="color: var(--main-green-color)">Motion</span>
            driven
          </h3>
          <h3 class="third-h3" data-scroll data-scroll-speed="0.2">
            <span class="span-reveal"></span
            ><span style="color: var(--main-green-color)">Experiences</span>
            defined
          </h3>
        </article>
      </section>
      ...
      <section class="four">
        <div class="mask-container">
          <article class="mask-article">
            <h2 class="text-mask" data-scroll>I`m a creative developer</h2>
          </article>

          <section class="side-section">
            <div class="inner-horizontal">
              <h2>what the agencies is needed</h2>
              <NuxtImg
                src="/images/first-image.jpg"
                alt="tawfik shaban"
                loading="lazy"
                ...
                fetchpriority="low"
              />
              <h2>i create a creative and unique web applications</h2>
              <NuxtImg
                ...
                fetchpriority="low"
              />
              <h2>i give agencies a unique identity</h2>
              <NuxtImg
                src="/images/sixth-image.jpeg"
                alt="tawfik shaban"
                loading="lazy"
                ...
                fetchpriority="low"
              />
              <h2>i shape brands that can`t be ignored</h2>
            </div>
          </section>
        </div>
      </section>

      <section class="five" data-scroll data-scroll-speed="0.2">
        <h2 data-scroll data-scroll-speed="0.3">
          <span class="span-reveal"></span>
          here you can take a look at my works
        </h2>
      ...
      <!-- about me
            ...
            <article>
                    <h1>
                        Hello There, My Name Is Tawfik Shaban
                        <br />,
    
                        I am Front End Developer With 3 Years Experience,
    
                        <br />
                        And If you wont building responsive,
                        high-performance web
                        applications, just contact Me
...
.loading-block .top {
  ...
  transition:
    ...
    clip-path 3s var(--main-transition);
  will-change: transform, clip-path;
  clip-path: xywh(0px 0px 100% 100% round 0% 0);
  border: 1px solid var(--main-color);
}

.loading-block .top h4 {
  font-size: 12px;
...
.loading-block .before {
  ...
  z-index: 999999;
  transition: transform 2s var(--main-transition);
}
...
.close {
  ...
  cursor: pointer;
  transition:
    color 0.3s var(--main-transition),
    border-color 0.3s var(--main-transition);
}
...
@media screen and (max-width: 767px) {
  ...
  .hero h1 {
    font-weight: 400;
    font-family: "PowerGroteskTrial", monospace !important;
  }
}
</style>
